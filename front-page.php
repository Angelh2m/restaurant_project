...
<div id="restaurant" class="content row">

	<div class="container" >
		<div  >

			<div class="col-8">
				<h2 id="frist_logo">Located in Park Slope, Pacific Tavern is a purveyor of fine American dining from the esteemed Chef Billy Lang.</h2>
		...
		<div class="gallery">
			...
			<div class="">
				<li class="active">
					<img
					src="<?php bloginfo('template_url'); ?>/img/breakfast.jpg"
					>
				</li>
				<li>
					<img
					src="<?php bloginfo('template_url'); ?>/img/salad.jpg"
					>
				</li>
				<li>
					<img
					src="<?php bloginfo('template_url'); ?>/img/drink.jpg"
					>
				</li>
...
<div class="drink_menu" id="drinks">
	...
	<div class="back_image" style="background: url('<?php bloginfo('template_url'); ?>/img/drink.jpg')" >
		<!-- <img
		class="drink_menu-image"
		src="<?php bloginfo('template_url'); ?>/img/drink.jpg"
		> -->
	</div>
...
<div class="reservations" id="reservations">
	<h1 id="clickButton">Make a reservation</h1>
	<h2>POWERED BY OPENTABLE</h2>
	<div>
		<a id="reservations_button" href="#" class="button">Find a Table</a>
	</div>
